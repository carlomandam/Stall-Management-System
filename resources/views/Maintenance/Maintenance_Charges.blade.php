...
<div class="defaultNewButton">
    <button style="padding: 1px 10px 4px 3px; border-radius:50px;" class="btn icon-btn btn-primary" data-toggle="modal" data-target="#new">
        ...
        <div class=" pull-right" id="archive"> <a href="{{ url('/StallTypeArchive') }}" style="padding: 2px 10px 3px 3px; border-radius:50px;" class="btn btn-primary btn-flat"><span style="padding:7px; background:#ffffff; margin-right:4px;" class='fa fa-archive img-circle text-primary'></span>&nbsp;Archive</a> 
        </div>
</div>
