...
<div class="defaultNewButton">
    ...
    <div class=" pull-right" id="archive"> <a style="padding: 2px 10px 3px 3px; border-radius:50px;" href="{{ url('/BuildingArchive') }}" class="btn btn-primary btn-flat"><span style="padding:7px; background:#ffffff; margin-right:4px;" class='fa fa-archive img-circle text-primary'></span>&nbsp;Archive</a> </div>
</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="bldgDesc">Building Description</label>
                        ...
                        <div class="tab-pane active" id="1">
                            <form class="building" action="" method="post" id="updateform">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="bldgDescUp">Building Description</label>
