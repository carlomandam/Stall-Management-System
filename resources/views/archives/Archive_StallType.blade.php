@extends('layout.app') @section('title') {{ 'Stall Type Archive'}}
<style type="text/css">
...
<div class="box box-primary">
    <div class="box-body">
        <div class="table-responsive">
            <div class="defaultNewButton"> <a href="{{ url('/StallType') }}" class="btn btn-primary btn-flat"><span class='fa fa-arrow-left'></span>&nbspBack</a> </div>
