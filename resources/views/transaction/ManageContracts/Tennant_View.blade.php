                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="fname" value="{{$tennant->stallHFName}}" placeholder="" required> </div>
                                    <div class="col-md-6">
                                        <label for="firstName"><b>StallHolder Middle Name</b></label><span class="required">&nbsp*</span>
                                        <input type="text" class="form-control" name="mname" value="{{$tennant->stallHMName}}" placeholder=""> </div>
                                    <div class="col-md-6">
                                        <label for="firstName"><b>StallHolder Last Name</b></label><span class="required">&nbsp*</span>
                                        <input type="text" class="form-control" name="lname" value="{{$tennant->stallHLName}}" placeholder="" required> </div>
                                    <div class="col-md-6">
                                        <label for="address"><b>Home Address</b></label><span class="required">&nbsp*</span>
                                        <textarea class="form-control" name="address">{{$tennant->stallHAddress}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email" value="{{$tennant->stallHEmail}}" placeholder="email@domain.com" /> </div>
                                    <div class="col-md-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You are about to delete records of <b>{{$tennant->stallHFName.' '.$tennant->stallHLName}}</b>, this procedure is irreversible.</p>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger btn-ok" onclick='deleteTennant("{{$tennant->stallHID}}");' data-dismiss="modal">Proceed</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#DOB").datepicker("setDate","{{date("F d, Y",strtotime($tennant->stallHBday))}}");
        ...
        $('form input[name=sex][value=' + {{$tennant -> stallHSex}} + ']').click();
        var contacts = JSON.parse("{{json_encode($tennant->ContactNo)}}".replace(/&quot;/g, '"'));
