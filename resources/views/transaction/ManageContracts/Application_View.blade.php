    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>You are about to reject a stall rental application from <b>{{$stallHolderDetails->stallHFName.' '.$stallHolderDetails->stallHLName}}</b>, this procedure is irreversible.</p>
