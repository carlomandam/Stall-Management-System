        ...
        <div class="tabcontent active" id="1">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><b>{{$contract->Stall->stallID}} Current Submeter Reading</b></h3> </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <label>Utilities <a href="/initialReading/{{$contract->contractID}}" style="font-size: 12px">Change Current Reading</a></label>
                            <p>@for($i=0;$i < count($contract->stall->StallUtility);$i++)
                                {{($contract->stall->StallUtility[$i]->utilityType == 1) ? "Electricity":(($contract->stall->StallUtility[$i]->utilityType == 2) ? "Water" : "Unkown Utility")}}@if($i < count($contract->stall->StallUtility)-1), @endif
                                @endfor
                        </div>
                        <div class="col-md-12">
