    ...
    <div class="box-body">
        <div class="table-responsive">
            <div class="defaultNewButton">
              <a href="/requirements">
                    <button class="btn btn-primary btn-flat"><span class='fa fa-arrow-left'></span>Back
                </button>
              </a>
                 ...
                 @foreach($req as $r)
                    <tr>
                        ...
                        <td>
                            ...
                            <div class='btn-group'>
                                <button type='button' class='btn btn-primary btn-flat dropdown-toggle' data-toggle='dropdown'><span class='fa fa-check'></span> Reactivate</button></button>
