...
<a class="btn btn-primary btn-flat" style="margin-left: 20px; margin-bottom: 10px;" href="<?php echo e(url('/Payment')); ?>"><span class='fa fa-arrow-left'></span>&nbspBack to Payment and Collections</a>
...
window.location.href = "<?php echo e(URL::to('/Payment')); ?>";
}
