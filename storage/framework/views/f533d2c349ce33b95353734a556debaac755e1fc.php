...
<div class="row">
    <div style="margin-left: 20px; margin-bottom: 10px;"> <a href="<?php echo e(url('/StallHolderList')); ?>#tab2primary" class="btn btn-primary btn-flat"><span class='fa fa-arrow-left'></span>&nbsp;Back</a> </div>
    <div class="col-md-12">
