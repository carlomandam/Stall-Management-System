            ...
            <table id="equipList" class="table table-bordered table-striped" role="grid">
                ...
                <?php $__currentLoopData = $equips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <button class='btn btn-primary btn-flat' id="updateModal" data-id='<?php echo e($equip->equipmentID); ?>'><span class='glyphicon glyphicon-pencil'></span> Update</button>
...
<script type="text/javascript" src="<?php echo e(URL::asset('js/equipment.js')); ?>"></script>
