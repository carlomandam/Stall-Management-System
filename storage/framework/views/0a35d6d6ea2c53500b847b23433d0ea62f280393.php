             ...
             <fieldset>
                ...
                <!--/.box-header-->
                        ...
                        <div class = "col-md-12 form-group row" id = "stallhold">
                            ...
                            <input type = "text" class = "form-control" id = "vendor_no" value = "<?php echo e($nextId); ?>" disabled=""  />
                      ...
                      <div class="col-md-12 form-group row">
                                    ...
                                    <div class="col-md-10">
                                      ...
                                      <select class="js-example-basic-single" style="width: 100%; " id = "stallno" name = "stallno_name">
                                        ...
                                        <?php for($i = 0; $i < $buildingCount; $i++): ?>
                                        {<optgroup label = '<?php echo e($buildingNames[$i]); ?>'>
                                            <?php $__currentLoopData = $stall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Stall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            {
                                                <?php if($buildingNames[$i] == $Stall->floor->building->bldgName): ?>
                                                {
                                                    
                                                        <option value = "<?php echo e($Stall->stallID); ?>"><?php echo e($Stall->stallID.'( Floor '. $Stall->floor->floorNo. ', '.$Stall->stalltype->stypeName.')'); ?></option>
...
<script>
    ...
    var stalls = JSON.parse(("<?php echo e($stall); ?>").replace(/&quot;/g,'"'));
    var val;
    var sel = 0;
