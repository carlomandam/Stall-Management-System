...
<body>
	...
	<h6 style="text-align: right;">Printed Date: <?php echo e(Carbon\Carbon::today()->format('F d,Y')); ?></h6>
	...
	<p class="body" style="margin-left: 10px;">	Our records indicate that your Contract in Stall <b><i><?php echo e($data->stallID); ?> </b></i> &nbsp is due to expire on <b><i> <?php echo e($data->endcon); ?> </b></i></p>
