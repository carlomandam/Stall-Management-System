                ...
                $.each(data, function(i,data){
                    ...
                    table.row.add([
                       ...
                       data.billDate,
                        ...
                        "<button class='btn btn-flat btn-success' onclick='window.location="+'"'+"<?php echo e(url('/ViewBill/"+this.value+"')); ?>"+'"'+"' class='btn btn-flat btn-primary' value = '"+data.billNo+"'  target ='_blank'><span class = 'fa  fa-print'></span>&nbspPrint Bill</button> "
