            ...
            <?php $__currentLoopData = $utils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $util): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <?php elseif($util->peakType==1): ?>
                    <select class="form-control" disabled id="ptype" name="peakType">
                      <option value="0">Fixed</option>
                      <option value="1" selected>Percatage</option>
                      <option value="2">Multiplier</option>
                    </select>
                    <?php elseif($util->peakType==2): ?>
                    <select class="form-control" disabled id="ptype" name="peakType">
                      <option value="0">Fixed</option>
                      <option value="1">Percatage</option>
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-md-5">
                      <input type="text" name="rate" class="form-control" value="<?php echo e($util->peakQuan); ?>" onkeypress="validate(event)" disabled id="rate">
                    </div>
                </div>
