                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                                      ...
                                                      <?php if($status == 'COLLECT'): ?>
                                                      <span class="label bg-primary"><?php echo e($status); ?></span>
                                                      <?php elseif($status == 'REMINDER'): ?>
                                                          <span class="label bg-green form-control"><label><?php echo e($status); ?></label></span>
                                                      <?php elseif($status == 'WARNING'): ?>
                                                          <span class="label yellow form-control"><label><?php echo e($status); ?></label></span>
                                                      <?php elseif($status == 'LOCK'): ?>
                                                          <span class="label bg-orange"><label><?php echo e($status); ?></label></span>
                                                      <?php elseif($status == 'TERMINATE'): ?>
                                                          <span class="label bg-red"><label><?php echo e($status); ?></label></span>
                                                     <?php endif; ?>
                                        </div>
                                        <label class="col-md-3">Balance</label>
                                        <div class="col-md-3">
                                            <label class="form-control">Php <?php echo e(number_format($totalUnpaid,2)); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php $total = 0;?> <?php if(count($contract->UnpaidInitial) > 0): ?>
                                            ...
                                            <?php if(isset($unpaidCollections)): ?>
                                            <div class="col-md-12">
                                                ...
                                                <ul style="list-style:none"> <?php $__currentLoopData = $unpaidCollections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <div class="checkbox" style="display:inline !important">
                                                            <label>
                                                                <input name="unpaid[]" style="width: 15px;height: 15px" type="checkbox" value="<?php echo e($u['detID']); ?>"> <?php echo e($u['date']); ?> - <?php echo e(date("l",strtotime($u['date']))); ?> </label>
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="pull-right col-md-4" style="margin-right:4%">
                                                    ...
                                                    <label>Total Amount:</label>&nbsp;₱ <?php echo e(number_format($total,2,'.',',')); ?>
