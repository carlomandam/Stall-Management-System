            ...
            <div>
                ...
                <div style="margin-left:10%;margin-right:10%;">
                    <p style="text-indent:50px">
                        <center> THIS AGREEMENT made this (day) <b><?php echo e(date_format(date_create($data['contract']->contractStart), 'd')); ?> </b>of (Month) <b><?php echo e(date_format(date_create($data['contract']->contractStart), 'F')); ?></b>, (Year) <b><?php echo e(date_format(date_create($data['contract']->contractStart), 'Y')); ?></b>,
                            <p>
                            ...
                            <p>
                                <center> <b>  <?php echo e($data['contract']->StallHolder->stallHFName. " ". $data['contract']->StallHolder->stallHMName[0]. ". ". $data['contract']->StallHolder->stallHLName); ?> </b>(VENDOR)</center>
                            </p> The OWNER and VENDOR hereby agree the rental of Stall No. <b> <?php echo e($data['contract']->stallID); ?> </b>located on (Floor) <b> <?php echo e($data['contract']->Stall->Floor->floorLevel); ?> </b>,(Building) <b> <?php echo e($data['contract']->Stall->Floor->Building->bldgName); ?>.</b> Commencing on this day until <?php echo e($data['contract']->contractEnd); ?>. This agreement is subject to the following terms and conditions: </center>
                    </p>
                    <br> </div>
                <div style="margin-left:10%;margin-right:10%;">
                    <p>1. Membership</p>
                    ...
                    <p style="text-indent:50px;">The contract shall be a term of starting on the (day) <?php if($data['contract']->contractStart != ""): ?> <b> <?php echo e(date_format(date_create($data['contract']->contractStart), 'd')); ?> </b> of (Month) <b> <?php echo e(date_format(date_create($data['contract']->contractStart), 'F')); ?> </b>,(Year) <b> <?php echo e(date_format(date_create($data['contract']->contractStart), 'Y')); ?> </b>.</p> <?php endif; ?>
                    ...
                    <p>4. Rental fees</p>
                    <p style="text-indent:50px;">Vendor shall pay rent of Php <?php echo e(number_format($data['contract']->StallRate->dblRate, 2, '.', ',')); ?> daily with additional <?php if($data['contract']->StallRate->peakRateType == 1): ?> Php.<?php echo e($data['contract']->StallRate->dblPeakRate); ?>

                    <?php elseif($data['contract']->StallRate->peakRateType == 2): ?> <?php echo e($data['contract']->StallRate->dblPeakRate . '% (Php.'.($data['contract']->StallRate->dblRate * $data['contract']->StallRate->dblPeakRate) / 100); ?>)<?php endif; ?> on peak days</p>
                    <p>5. Termination</p>
                ...
                <div style="margin-top:5%;">
                    <p>
                        <center>
                            ...
                            <input type="text" value="<?php echo e($data['contract']->StallHolder->stallHFName. ' '. $data['contract']->StallHolder->stallHMName[0]. '. '. $data['contract']->StallHolder->stallHLName); ?>" style="border:transparent;border-bottom:2px solid black;width:160px;background-color:transparent;margin-left:28%; text-align: center;" disabled> </center>
                    </p>
                    <p>
                        <center>
