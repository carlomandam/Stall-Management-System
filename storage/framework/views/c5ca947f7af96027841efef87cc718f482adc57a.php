    ...
    <div class="box-body">
        <div class="table-responsive">
            <div class="defaultNewButton">
                ...
                <div class=" pull-right" id="archive"> <a href="<?php echo e(url('/requirementsArchive')); ?>" class="btn btn-primary btn-flat"><span class='fa fa-archive'></span>&nbspArchive</a> </div>
            </div>
            <table id="reqList" class="table table-bordered table-striped" role="grid">
                ...
                <tbody> <?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <button class='btn btn-primary btn-flat' id="updateModal" data-id="<?php echo e($req->reqID); ?>"><span class='glyphicon glyphicon-pencil'></span> Update</button>
                            <div class='btn-group'>
