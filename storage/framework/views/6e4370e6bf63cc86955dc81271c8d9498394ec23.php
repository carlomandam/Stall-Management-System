...
<?php echo e('Balance Summary Report'); ?>
    ...
    <div class="box box-solid box-default">
        ...
        <div class = "col-xs-12"> 
          <div class="defaultNewButton">  
            <div class=" pull-right" id="print" style="margin-right: 20px; "> <a href="<?php echo e(url('/printBalanceReport')); ?>" class="btn btn-success btn-flat"  style="width: 200px;"><span class='fa fa-print'></span>&nbsp;Generate</a>
            </div>
          </div>
            ...
            <div class="col-md-12">
                  ...
                  <div class="box box-solid box-primary" style= "margin-top: 20px;">
                        <div class="box-header with-border">
                          <h4><center>Balance Summary as of today(<?php echo e(Carbon\Carbon::today()->format('F d,Y')); ?> )</center> </h4>
