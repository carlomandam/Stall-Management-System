...
class ChargeController extends Controller
{
    ...
    function getCharges(){
    	...
    	foreach ($charges as $charge) {
            $charge['actions'] = "<button class='btn btn-primary btn-flat' onclick='getInfo(this.value)' value = '".$charge['chargeID']."' style='padding: 2px 10px 4px 3px; border-radius:50px;' class='btn btn-primary btn-flat'><span class='glyphicon btn-glyphicon fa fa-pencil img-circle text-primary' style='padding:7px; background:#ffffff; margin-right:4px;'></span> Update</button>
